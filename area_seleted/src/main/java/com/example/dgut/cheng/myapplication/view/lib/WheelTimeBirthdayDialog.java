...
public class WheelTimeBirthdayDialog {
	...
	public WheelTimeBirthdayDialog(View view) {
		super();
		this.view = view;
		type = TimePopupWindow.Type.ALL;
		setView(view);
	}
	public WheelTimeBirthdayDialog(View view, TimePopupWindow.Type type) {
		super();
		this.view = view;
		this.type = type;
		setView(view);
	...
	public void setPicker(int year ,int month ,int day,int h,int m) {
		...
		Calendar c = Calendar.getInstance();
		int yearCode = c.get(Calendar.YEAR);
		int monthCode = c.get(Calendar.MONTH);
		int dayCode = c.get(Calendar.DAY_OF_MONTH);
		Context context = view.getContext();
		// 年
		wv_year = (WheelView) view.findViewById(R.id.year);
		wv_year.setAdapter(new NumericWheelAdapter(START_YEAR, yearCode));// 设置"年"的显示数据
		wv_year.setLabel(context.getString(R.string.pickerview_year));// 添加文字
		wv_year.setCurrentItem(END_YEAR);// 初始化时显示的数据
